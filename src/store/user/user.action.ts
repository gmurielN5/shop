...
export type CheckUserSession =
  Actions<USER_ACTION_TYPES.CHECK_USER_SESSION>;
...
export type GoogleSignInStart =
  Actions<USER_ACTION_TYPES.GOOGLE_SIGN_IN_START>;
...
export type SignOutStart = Actions<USER_ACTION_TYPES.SIGN_OUT_START>;

export type SignOutSuccess =
  Actions<USER_ACTION_TYPES.SIGN_OUT_SUCCESS>;
